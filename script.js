...
document.getElementById("loveIn").onclick = async function() {
    if (sudahKlik) {
        ...
        //setTimeout(function(){
	        ...
	        const popups = [
		        { teks: "Halooo Ibu Tersayang 😍", stiker: stikerPopup1.src, waktu: 2200 },
		        { teks: "Aku mau bilang sesuatu, Bu ❤️", stiker: stikerPopup2.src, waktu: 2200 },
		        { teks: "Tapi Ibu jangan kaget ya 🥰", stiker: stikerPopup3.src, waktu: 2200 },
		        { teks: "Hari inii...", stiker: stikerPopup4.src, waktu: 2200 },
		    ];
